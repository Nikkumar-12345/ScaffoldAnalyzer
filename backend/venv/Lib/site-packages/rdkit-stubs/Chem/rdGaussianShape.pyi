...
class ShapeInput(Boost.Python.instance):
    ...
    ShapeInput object
    """
    __instance_size__: typing.ClassVar[int] = 360
    @staticmethod
    def NormalizeCoords(arg1: ShapeInput) -> None:
        """
            ...
            C++ signature :
                void NormalizeCoords(class RDKit::GaussianShape::ShapeInput {lvalue})
        """
    @staticmethod
    ...
    def BestSimilarity(self, fitShape: ShapeInput, threshold: float = -1.0, overlayOpts: typing.Any = None) -> tuple:
        """
            ...
            C++ signature :
                class boost::python::tuple BestSimilarity(class RDKit::GaussianShape::ShapeInput {lvalue},class RDKit::GaussianShape::ShapeInput [,double=-1.0 [,class boost::python::api::object=None]])
        """
    def MaxPossibleSimilarity(self, fitShape: ShapeInput, overlayOpts: typing.Any = None) -> float:
        """
            ...
            C++ signature :
                double MaxPossibleSimilarity(class RDKit::GaussianShape::ShapeInput {lvalue},class RDKit::GaussianShape::ShapeInput {lvalue} [,class boost::python::api::object=None])
        """
    def ShapeToMol(self, includeColors: bool = False, withBonds: bool = True) -> rdkit.Chem.Mol:
        """
            ...
            C++ signature :
                class RDKit::ROMol * __ptr64 ShapeToMol(class RDKit::GaussianShape::ShapeInput {lvalue} [,bool=False [,bool=True]])
        """
...
class ShapeInputOptions(Boost.Python.instance):
    ...
    def includeDummies(*args, **kwargs):
        ...
    @property
    def shapePruneThreshold(*args, **kwargs):
        """
...
def ScoreMoleculeAllConformers(ref: Mol, fit: Mol, refOpts: typing.Any = None, fitOpts: typing.Any = None, overlayOpts: typing.Any = None) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple ScoreMoleculeAllConformers(class RDKit::ROMol,class RDKit::ROMol [,class boost::python::api::object=None [,class boost::python::api::object=None [,class boost::python::api::object=None]]])
    """
