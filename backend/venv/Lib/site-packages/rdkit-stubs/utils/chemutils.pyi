...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    **Returns**
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = 'C:/rdkit/build/temp.win-amd64-cpython-314/Release/rdkit_install\\share/RDKit\\Data\\atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    **Note**
    ...
    """
_atomDbName: str = 'C:/rdkit/build/temp.win-amd64-cpython-314/Release/rdkit_install\\share/RDKit\\Data\\atomdb.gdb'
